...
* Set Up the AWS Amplify CLI
  ...
  In this lesson we’ll show how to install the Amplify CLI,
  {{{pxref(Amplify Console)}}} [fn:1], and then configure it with an [[https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users.html][IAM
  user]] [fn:2] so we can begin creating new Amplify projects.
...
#+MACRO:VERSION Version 0.3.8 <2019-02-24 Sun 09:35>
